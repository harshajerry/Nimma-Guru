...
public final class ActivityCalendarBinding implements ViewBinding {
  ...
  private ActivityCalendarBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvEmpty,
  ...
  public static ActivityCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCalendarBinding((ConstraintLayout) rootView, tvEmpty, tvSessions);
    }
